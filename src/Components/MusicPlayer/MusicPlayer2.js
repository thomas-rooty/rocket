        ...
        <div className="ListOfTracks">
          {
            ...
            && this.state.data.map(
              ...
              <div>
                ...
                {
                  !row['favorite']
                  ? <FavoriteBorderIcon onClick={() => {this.addFav(row.MusicID, localStorage.getItem(TOKEN_KEY))}} sx={{ fontSize: 50}}/>
                : <FavoriteIcon onClick={ () => {this.deleteFav(row.MusicID, localStorage.getItem(TOKEN_KEY))}} sx={{ fontSize: 50}}/>
                }
              </div>
